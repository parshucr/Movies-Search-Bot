...
url_list = {}
api_key = "7ae5fc5ad592062607ca07e3f591ba2bd154b9dc"
...
def get_movie(query):
    ...
    if movie_page_link:
        ...
        final_links = {}
        for i in links:
            url = f"https://mdisklink.link/api?api=7ae5fc5ad592062607ca07e3f591ba2bd154b9dc&url=yourdestinationlink.com&alias=CustomAlias "
